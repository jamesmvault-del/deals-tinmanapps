// /lib/ctaEngine.js
// TinmanApps — Psychographic CTA + Subtitle Engine v4.0.6 “Context Harmonizer Edition”
// ───────────────────────────────────────────────────────────────────────────────
...
function chooseObject(objects, boosters, memory, cluster) {
  ...
  // BoosterDecayMemory — avoid last 3 boosters
...
// ModifierDeduper — cleans stacked adverbs before anchor
...
// Anchor logic with AnchorGuard++ + Harmony
function anchorSubtitle(sub, cluster, cta, category) {
  if (!sub) return sub;

  // CategoryAnchorOverride
