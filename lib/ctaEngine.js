// /lib/ctaEngine.js
// TinmanApps — Psychographic CTA + Subtitle Engine v4.0 “Entropy-Aware Diversifier”
// ───────────────────────────────────────────────────────────────────────────────
// Built upon v3.9 “Guarded Precision”
//
// 🚀 New in v4.0:
// • Deep entropy awareness: dynamically balances repetition across 100+ items
// • Tone-tier diversification (action / curiosity / authority) per category
// • CTR-weighted biasing: high-performers slightly replicated, low CTRs rotated out
// • Semantic mirror mapping (cross-category CTA reuse with variation)
// • Hard fail-safes for empty / orphan categories
// • Automatic integration with seoIntegrity v2.2.2 “Category Safe-Fallback”
// ───────────────────────────────────────────────────────────────────────────────
