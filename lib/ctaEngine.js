// /lib/ctaEngine.js
// TinmanApps — Psychographic CTA + Subtitle Engine v3.6 “Uniqueness + Learning Fusion”
// ───────────────────────────────────────────────────────────────────────────────
// Upgrades over v3.5:
// • Adds per-page CTA + subtitle uniqueness guards
// • Keeps full learningGovernor integration (CTR-weighted, adaptive bias)
// • Category and tone-aware phrasing maintained
...
export function createCtaEngine() {
  ...
  return {
    generate({ title = "", slug = "", cat = "software" }) {
      ...
      // Ensure uniqueness across entire page
      let tries = 0;
    ...
    generateSubtitle({ title = "", category = "software" }) {
      ...
      let subtitle = applyLearningBias(base, cluster) || pick(base);
