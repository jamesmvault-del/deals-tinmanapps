// /lib/ctaEngine.js
// TinmanApps — Psychographic CTA + Subtitle Engine v4.0.7 “Harmonic Edge Edition”
// ───────────────────────────────────────────────────────────────────────────────
// Built upon v4.0.6 “Context Harmonizer Edition (Stable Release)”
//
// 🚀 New in v4.0.7:
// • DynamicAnchorGuard — prevents anchors that duplicate CTA nouns or context roots
// • SmartSubtitleJoiner — fixes missing prepositions (“progress in your workflows”)
// • PostAnchorDeduper — second-pass cleanup after anchor injection
// • CategoryReinforcementBias — stronger override if title mentions its category
// • Expanded CTA + Subtitle diversity pools for high-volume scaling
// ───────────────────────────────────────────────────────────────────────────────
...
function anchorSubtitle(sub, cluster, cta, category) {
  ...
  const nounRoot = anchor.split(" ")[2]; // e.g. workflows, campaigns
