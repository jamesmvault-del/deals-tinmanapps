// /lib/ctaEngine.js
// TinmanApps — Psychographic CTA + Subtitle Engine v1.2
// Adds intelligent subtitle generation (SEO + CTR boost)
// Retains all adaptive, CTR-weighted, deterministic CTA logic.
...
// Archetype-based subheading templates (new)
