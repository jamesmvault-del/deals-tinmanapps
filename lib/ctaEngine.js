// /lib/ctaEngine.js
// TinmanApps — Psychographic CTA + Subtitle Engine v1.4 “Persistent Adaptive”
// Adds intelligent subtitle generation (SEO + CTR boost)
// Ensures adaptive CTAs are persisted in JSON (for category rendering)
// Retains CTR-weighted, archetype-aware deterministic logic
...
// Archetype-based subtitle templates
...
class CTAEngine {
  ...
  generate({ title, slug, cat, keywords = [] }) {
    ...
    // Special archetype-based modifiers
