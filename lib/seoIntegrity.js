// /lib/seoIntegrity.js
// ───────────────────────────────────────────────────────────────────────────────
// TinmanApps — SEO Integrity Engine v4.5
// “Deterministic • Context-Aware • Category-Pure • Entropy-Aware • Sentence-Scoped Integrity”
//
// PURPOSE:
// • Guarantees SEO fields (cta, subtitle, clickbait, keywords) ALWAYS exist.
// • Contextual alignment: validates presence of product name & category lexicon.
// • Subtitle: 2 sentences, ≤160 chars, no title echo, no banned terms.
// • Adds product-name awareness + entropy diagnostics.
...
// ───────────────────────────────────────────────────────────────────────────────
// Integrity QA (v10.1 checks, contextual)
// ───────────────────────────────────────────────────────────────────────────────
...
function validateSeoFields(item, category) {
  ...
  // Subtitle structure: must include 2 sentences
  ...
  // Product name presence (context check)
...
export function ensureSeoIntegrity(feed) {
  ...
  console.log(`✅ [SEO Integrity v4.5] ${updated.length} verified. Entropy CTA:${eCTA} Subtitle:${eSUB}`);
